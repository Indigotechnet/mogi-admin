  ...
  grunt.initConfig({
    ...
    watch: {
      main: {
        ...
        files: ['js/**/*','css/**/*','img/**/*', 'scripts/**/*','partial/**/*','service/**/*','filter/**/*','directive/**/*','index.html'],
        tasks: ['jshint']
      }
    },
    jshint: {
    ...
    copy: {
      main: {
        files: [
          ...
          {src: ['scripts/jwplayer/**'], dest: 'dist/',filter:'isFile',expand:true, flatten: false},
          {src: ['bower_components/bootstrap/dist/fonts/**'], dest: 'dist/fonts/',filter:'isFile',expand:true, flatten: true},
          {src: ['ruler/**'], dest: 'dist/',filter:'isFile',expand:true}
